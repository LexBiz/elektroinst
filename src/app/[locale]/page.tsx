...
export default async function Home({ params }: HomeProps) {
  ...
  const works = [
    {
      img: "/portfolio/cable-routing.jpg",
      titleCs: "Rozvod kabelů v novém bytě 2+kk — Praha 5",
      titleUk: "Розводка кабелів у новій квартирі 2+кк — Прага 5",
      descCs: "Udělali jsme kompletní rozvod kabelů podle projektové dokumentace: silové okruhy, zásuvkové větve, příprava na internet a rezervní trasy pro budoucí techniku. Vše pečlivě označeno a připraveno pro revizi.",
      descUk: "Виконали повну розводку кабелів за проєктом: силові лінії, розеткові гілки, підготовка під інтернет та резервні траси для майбутньої техніки. Усе промарковано і підготовлено до ревізії.",
    },
    {
      img: "/portfolio/switchboard.jpg",
      titleCs: "Montáž a zapojení rozvaděče — Brno",
      titleUk: "Монтаж і підключення електрощита — Брно",
      descCs: "Osadili jsme nový rozvaděč, rozdělili okruhy po místnostech a osadili proudové chrániče. Po dokončení jsme provedli měření izolace, test jističů a předali kompletní fotodokumentaci.",
      descUk: "Змонтували новий щит, розподілили лінії по приміщеннях та встановили ПЗВ. Після завершення зробили виміри ізоляції, перевірку автоматів і передали повний фотозвіт.",
    },
    {
      img: "/portfolio/lighting.jpg",
      titleCs: "Instalace osvětlení kancelářských prostor — Praha 1",
      titleUk: "Монтаж освітлення в офісних приміщеннях — Прага 1",
      descCs: "Namontovali jsme nové stropní LED panely, oddělili světelné zóny a nastavili spínání po sekcích. Výsledkem je rovnoměrné světlo bez blikání a nižší spotřeba energie.",
      descUk: "Встановили нові стельові LED-панелі, розділили освітлення на зони та налаштували керування по секціях. Результат — рівномірне світло без мерехтіння і менше споживання.",
    },
    {
      img: "/portfolio/outlets.jpg",
      titleCs: "Montáž zásuvek a vypínačů v rodinném domě — Kladno",
      titleUk: "Монтаж розеток і вимикачів у приватному будинку — Кладно",
      descCs: "Vyměnili jsme staré prvky za nové, sjednotili výšku osazení a připravili samostatné okruhy pro kuchyňské spotřebiče. Každý bod byl proměřen a označen v dokumentaci.",
      descUk: "Замінено старі елементи на нові, вирівняно висоту встановлення та виділено окремі лінії для кухонної техніки. Кожну точку перевірено і зафіксовано в документації.",
    },
    {
      img: "/portfolio/maintenance.jpg",
      titleCs: "Diagnostika poruchy a servis elektroinstalace — Praha 8",
      titleUk: "Діагностика несправності та сервіс електрики — Прага 8",
      descCs: "Klient řešil opakované výpadky jističe. Zjistili jsme přetížený okruh, vyměnili poškozené spoje a přerozdělili zátěž. Po zásahu běží provoz stabilně bez výpadků.",
      descUk: "У клієнта постійно вибивало автомат. Знайшли перевантажену лінію, замінили пошкоджені з’єднання та перерозподілили навантаження. Після ремонту мережа працює стабільно.",
    },
    {
      img: "/portfolio/emergency.jpg",
      titleCs: "Nouzový výjezd 24/7 — obnova napájení po zkratu",
      titleUk: "Аварійний виїзд 24/7 — відновлення живлення після КЗ",
      descCs: "Ve večerních hodinách jsme vyjeli k objektu bez proudu. Lokalizovali jsme zkrat v poškozeném vedení, provedli bezpečnou výměnu a obnovili napájení během stejného výjezdu.",
      descUk: "Увечері виїхали на об’єкт без електрики. Локалізували коротке замикання в пошкодженій лінії, безпечно замінили ділянку та відновили живлення в межах одного виїзду.",
    },
  ];
